...
if [ "$key" = win ]; then
    ...
    allowed='^(kernel32|user32|gdi32|winmm|imm32|ole32|oleaut32|shell32|shlwapi|comctl32|comdlg32|uxtheme|xinput1_[34]|xinput9_1_0|version|setupapi|psapi|psapi|psapi|advapi32|msvcrt|ucrtbase|ws2_32|iphlpapi|cfgmgr32|api-ms-win-.*|sdl2(_image|_mixer|_ttf)?)\.dll$'
